...
class MainActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    fun permissionDenied(requestCode: Int){
        Toast.makeText(this.applicationContext, "권한이 없습니다.", Toast.LENGTH_SHORT).show()
    }
            ...
            override fun onLocationResult(locationResult: LocationResult?) {
                locationResult?.let {
                    for (location in it.locations) {
                        var text: String = "위도 : " + location.latitude + "\n경도 : " + location.longitude + "\n"
    ...
    fun setLastLocation(lastLocation: Location){
        ...
        val markerOptions = MarkerOptions().position(LATLNG).title("Here!") // 사용자의 위치 표시 마커 생성
